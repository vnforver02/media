...
export default function AdminSiteSettingsPage() {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        console.log('[Admin Settings] Raw API response:', data);
        console.log('[Admin Settings] First item:', data[0]);
        console.log('[Admin Settings] Company phone from API:', data[0]?.company_phone);
        setSettings(data[0] || {});
      } catch (error) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log('[Admin Settings] Company phone before save:', settings.company_phone);
      ...
      if (res.ok) {
        ...
        console.log('[Admin Settings] API response after save:', updated);
        console.log('[Admin Settings] Company phone after save:', updated?.company_phone);
        setSettings(updated);
